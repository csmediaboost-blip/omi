...
export type NodeTier = {
  ...
  tdp: string;
  architecture: string;
  // NEW: Mining system fields (replaces dailyEarning for pay-as-you-go mining)
  profitMin: number; // Minimum daily profit ($0.29)
  profitMax: number; // Maximum daily profit ($0.40)
  roiMultiplier: number; // Node-specific ROI tier (1.0 = Foundation, 1.1 = RTX/A100, 1.4 = H100)
};
...
export const NODES: Record<NodeKey, NodeTier> = {
  ...
  rtx3060: {
    ...
    profitMin: 0.29,
    profitMax: 0.40,
    roiMultiplier: 1.0, // Foundation Node baseline
  },
  rtx3090: {
    key: "rtx3090",
    name: "RTX 3090 Node",
  ...
  rtx4090: {
    ...
    profitMin: 0.29,
    profitMax: 0.40,
    roiMultiplier: 1.1, // +10% from Foundation
  },
  a100: {
    key: "a100",
  ...
  h100: {
    ...
    profitMin: 0.29,
    profitMax: 0.40,
    roiMultiplier: 1.4, // +40% from Foundation (highest tier)
  },
