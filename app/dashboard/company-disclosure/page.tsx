...
function DocPage({ children }: { children: React.ReactNode }) {
  return (
    <div
      className="bg-white min-h-screen w-full max-w-4xl mx-auto px-4 sm:px-8 md:px-16 py-8 sm:py-10 md:py-14 text-slate-900"
      style={{
...
function PageHeader({
  ...
  return (
    <div className="mb-6 sm:mb-10 pb-4 sm:pb-6 border-b-2 border-slate-800">
      ...
      <h1
        className="text-2xl sm:text-3xl md:text-4xl font-bold text-slate-900 mt-3 sm:mt-4 mb-2"
...
function PageFooterSimple({ pg, total }: { pg: number; total: number }) {
  return (
    <div className="mt-8 sm:mt-12 md:mt-14 pt-3 sm:pt-5 border-t border-slate-300">
...
function PageFooter({ pg, total }: { pg: number; total: number }) {
  return (
    <div className="mt-8 sm:mt-12 md:mt-14 pt-4 sm:pt-6 md:pt-8 border-t border-slate-300">
      <div className="flex flex-col sm:flex-row items-start sm:items-end justify-between gap-6">
        ...
        <div className="flex flex-col items-center gap-1 sm:gap-0.5">
          ...
          <div className="w-20 sm:w-28 border-b border-slate-400" />
          <p className="text-xs font-semibold text-slate-700">{CO.signatory}</p>
          <p className="text-[9px] text-slate-500">{CO.sigTitle}</p>
        </div>
        <div className="flex flex-col items-end gap-1">
          <div className="w-12 h-12 sm:w-14 sm:h-14 border-2 border-double border-slate-700 flex items-center justify-center">
            <div className="text-center px-0.5">
              <p className="text-[5px] sm:text-[6px] font-black text-slate-700 tracking-wider">
                OMNITASK
              </p>
              <p className="text-[5px] sm:text-[6px] font-black text-slate-700 tracking-wider">
                PRO LTD.
...
function H2({ children }: { children: React.ReactNode }) {
  return (
    <h2 className="text-lg sm:text-xl font-bold text-slate-800 mt-6 sm:mt-10 mb-2 sm:mb-3 pb-2 border-b border-slate-200">
      {children}
    </h2>
  );
}
...
function P({ children }: { children: React.ReactNode }) {
  return (
    <p className="text-slate-700 mb-3 sm:mb-4 text-[13px] sm:text-[14.5px] leading-[1.85] sm:leading-[1.9]">
      {children}
    </p>
  );
}
...
function Row({ label, value }: { label: string; value: string }) {
  return (
    <div className="flex flex-col sm:flex-row border-b border-slate-200 py-2 sm:py-2.5 gap-1 sm:gap-0">
      <span className="w-full sm:w-64 text-xs sm:text-sm font-semibold text-slate-600 shrink-0">
        {label}
      </span>
      <span className="text-xs sm:text-sm text-slate-800">{value}</span>
    </div>
  );
}
function InfoBox({
  ...
  return (
    <div className="bg-slate-50 border border-slate-200 p-4 sm:p-6 my-4 sm:my-6">
      <p className="text-xs font-bold tracking-widest uppercase text-slate-500 mb-3 sm:mb-4">
        {title}
      </p>
      {children}
    </div>
  ...
  const pages = [
    // ═══════════════════════════════════════════════════════════════ PAGE 1 ═══
    {
      ...
      content: (
        ...
        >
          <div className="border-b border-slate-700 px-4 sm:px-8 md:px-16 py-3 sm:py-4 flex flex-col sm:flex-row justify-between gap-2">
          ...
          <div className="flex-1 flex flex-col justify-between px-4 sm:px-8 md:px-16 py-8 sm:py-10 md:py-14">
            <div>
              <div className="flex items-center gap-3 sm:gap-4 mb-8 sm:mb-12">
                <div className="w-12 h-12 sm:w-16 sm:h-16 border-2 border-emerald-500 flex items-center justify-center shrink-0">
                  <span className="text-emerald-400 font-black text-lg sm:text-xl">
                    OT
                  </span>
                </div>
                <div>
                  <p className="text-emerald-400 font-bold text-base sm:text-lg tracking-wider">
                    OmniTask Pro Ltd.
                  </p>
              ...
              <div className="border-t border-slate-700 pt-6 sm:pt-10 mb-6 sm:mb-10">
                <p className="text-slate-400 text-xs sm:text-sm tracking-[0.3em] uppercase mb-2 sm:mb-4">
                  Official company-disclosure & Transparency Documentation
                </p>
                <h1
                  className="text-3xl sm:text-4xl md:text-6xl font-bold text-white leading-tight mb-4"
                ...
                <p className="text-slate-400 text-xs sm:text-base md:text-lg mt-4 sm:mt-6 max-w-xl leading-relaxed">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-8 border-t border-slate-700 pt-6 sm:pt-10">
                {[
            ...
            <div className="border-t border-slate-600 pt-6 sm:pt-8 mt-8 sm:mt-14">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-12">
                <div>
                  ...
                  <div className="border-b border-slate-500 w-40 sm:w-64 mt-2 sm:mt-3 mb-2" />
                ...
                <div className="flex items-end justify-end">
                  <div className="border-2 border-slate-600 w-24 h-24 sm:w-32 sm:h-32 flex items-center justify-center">
                    <div className="text-center px-1 sm:px-2">
                      <p className="text-slate-400 text-[7px] sm:text-[9px] font-black tracking-widest leading-tight">
                        OMNITASK
                      </p>
                      <p className="text-slate-400 text-[7px] sm:text-[9px] font-black tracking-widest leading-tight">
                        PRO LTD.
                      </p>
                      <div className="border-t border-slate-500 my-0.5 sm:my-1 mx-1" />
    ...
    // ═══════════════════════════════════════════════════════════════ PAGE 2 ═══
    {
      ...
      content: (
        <DocPage>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 sm:gap-4 my-5">
            {[
              ...
              <div key={d} className="border border-slate-200 p-3 sm:p-4">
                <p
          ...
          <PageFooterSimple pg={3} total={10} />
        </DocPage>
      ),
    },
    ...
    // ═══════════════════════════════════════════════════════════════ PAGE 5 ═══
    {
      ...
      content: (
        <DocPage>
          ...
          <PageFooterSimple pg={5} total={10} />
        </DocPage>
      ),
    },
    ...
    // ═══════════════════════════════════════════════════════════════ PAGE 9 ═══
    {
      ...
      content: (
        <DocPage>
          ...
          <PageFooterSimple pg={9} total={10} />
        </DocPage>
      ),
    },
