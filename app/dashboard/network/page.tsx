...
// Using Math.random() at module level causes Next.js hydration mismatches.
const LIVE: string[] = [];
{
  let pi = 0,
    ai = 0;
  ...
  for (let i = 0; i < totalEntries; i++) {
    // Pattern: prize, prize, prize, activity, activity (60/40)
    const slot = i % 5;
...
/* ─── Live Ticker — FULL WIDTH, no truncation, mobile-friendly ─── */
function LiveTicker() {
    ...
    >
      ...
      <div className="max-w-lg mx-auto px-4 py-5 space-y-4">
        ...
        <div>
          ...
          {/* ── FULL-WIDTH LIVE TICKER (mobile-friendly, no truncation) ── */}
          <div
