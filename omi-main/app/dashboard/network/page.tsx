...
// ── 100+ prize winners (global: Nigeria, UK, US, Ghana, Africa, Asia, Europe) ─
const LIVE_PRIZE: string[] = [
  // Nigeria
  "🏆 Emeka O. (Lagos) just won a Luxury Car!",
  "📱 Fatima A. (Abuja) won iPhone 17 Pro + Samsung S25 Ultra!",
  "❄️ Ngozi E. (Port Harcourt) won Samsung Bespoke Fridge!",
  "🏆 Chidi N. (Enugu) claimed his Luxury Car prize today!",
  "📱 Adaeze O. (Lagos) won the dual flagship phone bundle!",
  "❄️ Oluwaseun A. (Ibadan) received her Bespoke Fridge — shipped!",
  "🏆 Babatunde F. (Lagos) won a Luxury Car this month!",
  "📱 Yusuf A. (Kano) won iPhone 17 Pro + S25 Ultra — confirmed!",
  "❄️ Amaka C. (Onitsha) claimed Samsung Fridge prize!",
  "🏆 Kelechi U. (Owerri) — Luxury Car winner, keys handed over!",
  "📱 Tunde M. (Abuja) won the dual flagship bundle!",
  "❄️ Chisom A. (Aba) received her Bespoke Fridge!",
  "🏆 Blessing O. (Lagos) — Luxury Car prize collected!",
  "📱 Ifeanyi N. (Awka) won iPhone 17 Pro + S25 Ultra!",
  "❄️ Nneka B. (Kaduna) won Samsung Bespoke Fridge!",
  // UK
  "🏆 James S. (London) just won a Luxury Car!",
  "📱 Emma J. (Manchester) won iPhone 17 Pro + Samsung S25 Ultra!",
  "❄️ Oliver W. (Birmingham) won a Samsung Bespoke Fridge!",
  "🏆 Sophia B. (Leeds) claimed her Luxury Car prize today!",
  "📱 Harry T. (Bristol) won the dual flagship phone bundle!",
  "❄️ Charlotte D. (Liverpool) received her Bespoke Fridge!",
  "🏆 Liam C. (Sheffield) won a Luxury Car this month!",
  "📱 Isla M. (Edinburgh) won iPhone 17 Pro + S25 Ultra!",
  "❄️ Noah A. (Glasgow) claimed Samsung Fridge prize!",
  "🏆 Grace H. (Cardiff) — Luxury Car winner, keys handed over!",
  "📱 Jack P. (London) won the dual flagship bundle!",
  "❄️ Amelia R. (Nottingham) received her Bespoke Fridge!",
  // US
  "🏆 Michael J. (New York) just won a Luxury Car!",
  "📱 Sarah W. (Los Angeles) won iPhone 17 Pro + Samsung S25 Ultra!",
  "❄️ David B. (Chicago) won a Samsung Bespoke Fridge!",
  "🏆 Ashley M. (Houston) claimed her Luxury Car prize today!",
  "📱 Christopher D. (Phoenix) won the dual flagship phone bundle!",
  "❄️ Jessica T. (Philadelphia) received her Bespoke Fridge!",
  "🏆 Daniel W. (San Antonio) won a Luxury Car this month!",
  "📱 Amanda G. (Dallas) won iPhone 17 Pro + S25 Ultra!",
  "❄️ Joshua R. (Austin) claimed Samsung Fridge prize!",
  "🏆 Stephanie L. (Miami) — Luxury Car winner, keys handed over!",
  "📱 Ryan K. (Seattle) won the dual flagship bundle!",
  "❄️ Nicole A. (Atlanta) received her Bespoke Fridge!",
  // Ghana
  "🏆 Kwame B. (Kumasi) just won a Luxury Car!",
  "📱 Akosua M. (Accra) won iPhone 17 Pro + Samsung S25 Ultra!",
  "❄️ Kofi A. (Tamale) won a Samsung Bespoke Fridge!",
  "🏆 Abena D. (Cape Coast) claimed her Luxury Car prize today!",
  "📱 Kojo S. (Tema) won the dual flagship phone bundle!",
  "❄️ Ama O. (Sunyani) received her Bespoke Fridge!",
  "🏆 Kwesi F. (Accra) — Luxury Car winner, keys handed over!",
  // Other Africa / Global
  ...
  "📱 Linda C. (Nairobi) — dual phone bundle confirmed!",
  "❄️ Chen W. (Accra) won a Samsung Bespoke Fridge — shipped!",
  "🏆 Ahmed R. (Casablanca) claimed Luxury Car prize!",
  "📱 Priya S. (Dubai) won iPhone 17 Pro + S25 Ultra!",
  "❄️ Marco T. (Milan) received Samsung Bespoke Fridge!",
  "🏆 Ana L. (São Paulo) — Luxury Car prize delivered!",
  "📱 Mohammed A. (Riyadh) won the dual flagship bundle!",
  "❄️ Sofia K. (Toronto) received her Bespoke Fridge!",
];

// ── 100+ referral activity (global mix) ──────────────────────────────────────
const LIVE_ACTIVITY: string[] = [
  // Nigeria
  "Emeka O. (Lagos) joined via referral · earned $12.40",
  "Fatima A. (Abuja) activated Node · referrer got $24.80",
  "Chidi N. (Enugu) completed 7 tasks today",
  "Ngozi E. (Port Harcourt) just joined · GPU plan active",
  "Adaeze O. (Lagos) upgraded plan · $31.50 bonus paid",
  "Babatunde F. (Lagos) referred 3 users this week",
  "Yusuf A. (Kano) joined via referral · $8.20 earned",
  "Amaka C. (Onitsha) activated license · referrer credited",
  "Kelechi U. (Owerri) completed 12 tasks · $45.60 earned",
  "Oluwaseun B. (Ibadan) upgraded to Pro · referrer got $18.00",
  "Tunde M. (Abuja) referred 5 users this week · $62.50 earned",
  "Chisom A. (Aba) joined via referral · activated license",
  "Blessing O. (Lagos) completed 9 tasks · $33.30 earned",
  "Ifeanyi N. (Awka) upgraded plan · $27.90 bonus paid",
  "Nneka B. (Kaduna) joined via referral · GPU plan active",
  "Seun A. (Lagos) activated Node · referrer got $21.60",
  "Obiora C. (Enugu) referred 4 users · $48.00 earned",
  "Uchenna O. (Owerri) completed 15 tasks today",
  // UK
  "James S. (London) joined via referral · earned $15.60",
  "Emma J. (Manchester) activated Node · referrer got $31.20",
  "Oliver W. (Birmingham) completed 8 tasks today",
  "Sophia B. (Leeds) just joined · GPU plan active",
  "Harry T. (Bristol) upgraded plan · $42.00 bonus paid",
  "Charlotte D. (Liverpool) referred 4 users this week",
  "Liam C. (Sheffield) joined via referral · $11.80 earned",
  "Isla M. (Edinburgh) activated license · referrer credited",
  "Noah A. (Glasgow) completed 15 tasks · $55.50 earned",
  "Grace H. (Cardiff) joined via referral · GPU plan active",
  "Jack P. (London) upgraded to Pro · referrer got $22.40",
  "Olivia R. (Manchester) referred 6 users · $75.00 earned",
  "William B. (Leeds) joined via referral · activated license",
  "Amelia G. (Birmingham) completed 11 tasks · $40.70 earned",
  "George M. (Bristol) upgraded plan · $35.10 bonus paid",
  "Freya T. (London) activated Node · referrer got $28.60",
  "Archie C. (Manchester) referred 3 users · $37.50 earned",
  // US
  "Michael J. (New York) joined via referral · earned $18.90",
  "Sarah W. (Los Angeles) activated Node · referrer got $37.80",
  "David B. (Chicago) completed 10 tasks today",
  "Ashley M. (Houston) just joined · GPU plan active",
  "Christopher D. (Phoenix) upgraded plan · $51.00 bonus paid",
  "Jessica T. (Philadelphia) referred 5 users this week",
  "Daniel W. (San Antonio) joined via referral · $14.30 earned",
  "Amanda G. (Dallas) activated license · referrer credited",
  "Joshua R. (Austin) completed 18 tasks · $66.60 earned",
  "Stephanie L. (Miami) joined via referral · GPU plan active",
  "Matthew K. (New York) upgraded to Pro · referrer got $28.60",
  "Jennifer S. (Chicago) referred 7 users · $87.50 earned",
  "Ryan T. (Houston) joined via referral · activated license",
  "Nicole A. (Los Angeles) completed 13 tasks · $48.10 earned",
  "Brandon C. (Dallas) upgraded plan · $43.20 bonus paid",
  "Tyler M. (Seattle) activated Node · referrer got $19.80",
  "Kayla B. (Atlanta) referred 4 users this week · $50.00 earned",
  // Ghana
  "Kwame B. (Kumasi) joined via referral · earned $9.80",
  "Akosua M. (Accra) activated Node · referrer got $19.60",
  "Kofi A. (Tamale) completed 6 tasks today",
  "Abena D. (Cape Coast) just joined · GPU plan active",
  "Kojo S. (Tema) upgraded plan · $28.50 bonus paid",
  "Ama O. (Sunyani) referred 2 users this week",
  "Kwesi F. (Accra) joined via referral · $7.40 earned",
  "Efua B. (Kumasi) activated license · referrer credited",
  "Nana A. (Accra) completed 9 tasks · $33.30 earned",
  "Yaw K. (Tema) upgraded to Pro · referrer got $15.80",
  // Other Africa / Global
  "Chen W. (Accra) upgraded plan · $31.50 bonus paid",
  "Aisha B. (Cairo) referred 3 users this week",
  "David N. (Nairobi) joined via referral · $8.20 earned",
  "Grace I. (Kampala) activated license · referrer credited",
  "Linda C. (Nairobi) completed 14 tasks · $51.80 earned",
  "James O. (Dar es Salaam) joined via referral · GPU plan active",
  "Maria T. (Kampala) upgraded to Pro · referrer got $19.20",
  "Daniel K. (Nairobi) referred 4 users this week · $50.00 earned",
  "Ahmed R. (Casablanca) joined via referral · $10.60 earned",
  "Priya S. (Dubai) activated Node · referrer got $26.40",
  "Marco T. (Milan) completed 11 tasks today",
  "Ana L. (São Paulo) just joined · GPU plan active",
  "Sofia K. (Toronto) upgraded plan · $38.00 bonus paid",
  "Mohammed A. (Riyadh) referred 3 users this week",
  "Yuki T. (Tokyo) joined via referral · $13.20 earned",
  "Carlos M. (Madrid) activated license · referrer credited",
];

// ── Deterministic interleave (~60% prize, ~40% activity) — no Math.random() ──
const LIVE: string[] = [];
{
  let pi = 0,
    ai = 0;
  const totalEntries = LIVE_PRIZE.length + LIVE_ACTIVITY.length;
  for (let i = 0; i < totalEntries; i++) {
    const slot = i % 5;
    if (slot < 3 && pi < LIVE_PRIZE.length) {
      LIVE.push(LIVE_PRIZE[pi++]);
    } else if (ai < LIVE_ACTIVITY.length) {
      LIVE.push(LIVE_ACTIVITY[ai++]);
    } else if (pi < LIVE_PRIZE.length) {
      LIVE.push(LIVE_PRIZE[pi++]);
    }
  }
}
...
function LiveTicker() {
  ...
  return (
    <div
      className="flex items-start gap-2 w-full py-1"
      style={{ minHeight: 28 }}
    >
      <div
        className={`w-2 h-2 rounded-full shrink-0 mt-1 animate-pulse ${
          isPrize ? "bg-yellow-400" : "bg-emerald-400"
        }`}
      />
      <span
        style={{
          ...
          opacity: vis ? 1 : 0,
          color: isPrize ? "rgba(253,224,71,0.85)" : "rgba(147,197,253,0.75)",
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(135deg, rgba(245,158,11,0.12), rgba(10,22,40,0.98))",
      ...
      >
        <div className="flex items-center gap-3 min-w-0">
          ...
          <div className="min-w-0">
            ...
            <p className="text-amber-400/60 text-xs leading-tight">
              Fill in to qualify for prize delivery
            </p>
          </div>
        </div>
        {allowClose && (
          <button
            onClick={onClose}
            className="ml-3 shrink-0 w-8 h-8 flex items-center justify-center rounded-full transition-colors"
      ...
      <div className="flex-1 overflow-y-auto">
        <div className="px-4 py-5 space-y-3 max-w-md mx-auto w-full pb-10">
          {done ? (
            ...
            <>
              ...
              >
                ...
                <p className="text-yellow-300/80 text-xs leading-relaxed">
                  Your delivery address is needed to ship your prize when you
                  win. Fill in accurate details.
                </p>
              </div>
              ...
              >
                Fields marked <span className="text-amber-500">*</span> are
                required &nbsp;·&nbsp; Used only for prize delivery
              </p>
            </>
          )}
        </div>
...
export default function NetworkPage() {
  ...
  // ── CHANGE 1: Prize winner state ──
  const [prizeWin, setPrizeWin] = useState<{
    prize_id: string;
    title: string;
  } | null>(null);

  // Check if this user has been marked a winner this month
  useEffect(() => {
    async function checkWin() {
      ...
      if (win) {
        const titles: Record<string, string> = {
          ...
          phone_bundle: "📱 iPhone 17 Pro + Samsung S25 Ultra",
          fridge: "❄️ Samsung Bespoke Fridge",
        };
        setPrizeWin({
          prize_id: win.prize_id,
          title: titles[win.prize_id] ?? "a Prize",
        });
      }
    }
    checkWin();
          ...
          >
            <div className="relative z-10">
              ...
              <p className="text-slate-700 text-xs mt-1.5">
                Our team will contact you using your registered delivery details
                to arrange delivery.
              </p>
            </div>
          </div>
              ...
              {[
                {
                  ...
                  d: "Submit once — saved for all future visits",
                },
                {
                  n: "2",
                  t: "Share your link",
