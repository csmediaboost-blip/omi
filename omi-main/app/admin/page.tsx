  ...
  return (
    <AdminLayout>
      <div className="space-y-6">
        ...
        {/* ── KoraPay Accounts card ── */}
        <Link href="/admin/korapay-accounts" className="block">
          <Card className="bg-white border-gray-200 hover:border-amber-300 transition-colors cursor-pointer">
            <CardHeader>
              <Landmark className="text-amber-500 mb-2" size={24} />
              <CardTitle className="text-gray-900">KoraPay Accounts</CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-sm text-gray-600">
                Manage up to 10 KoraPay API keys with automatic daily limit
                rotation. View per-account usage and remaining capacity.
              </p>
            </CardContent>
          </Card>
        </Link>
        ...
        <Link href="/admin/support-tickets" className="block">
          <Card className="bg-white border-gray-200 hover:border-emerald-300 transition-colors cursor-pointer">
            <CardHeader>
            ...
            <CardContent>
              <p className="text-sm text-gray-600">
                View and manage customer support tickets and respond to complaints
              </p>
            </CardContent>
          </Card>
        </Link>
