...
export function SignInForm() {
  ...
  const onSubmit = async (data: SignInFormData) => {
    try {
      ...
      // Clear any stale pin verification cookies
      ...
      // Force full page reload with window.location.href
      // This bypasses Next.js client-side cache and ensures middleware runs
